...
points_df = pd.read_csv(r'D:\pycharm_code\HiMICd-NCP-main\Data Samples_HiMICd_NCP\Fig7 data\point.csv')
# Read station observation data
obs_df = pd.read_csv(r'D:\pycharm_code\HiMICd-NCP-main\Data Samples_HiMICd_NCP\Fig7 data\combined_data_2018.csv')
...
# Save image
export_path = r'D:\pycharm_code\HiMICd-NCP-main\Data Samples_HiMICd_NCP\Fig7 data\Results\{}_{}_HiMIC_zoomed.pdf'.format(index_name, date)
